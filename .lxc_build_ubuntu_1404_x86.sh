...
lxc init mbs-ubuntu-1404-x86 ${CONTAINER}
...
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1404_x86_lua5.1.tar.gz --gzip --directory /tmp/work/build/linux/lua5.1/install/ .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1404_x86_lua5.2.tar.gz --gzip --directory /tmp/work/build/linux/lua5.2/install/ .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1404_x86_lua5.3.tar.gz --gzip --directory /tmp/work/build/linux/lua5.3/install/ .'
lxc file pull ${CONTAINER}/tmp/work/build/build_ubuntu_1404_x86_lua5.1.tar.gz build/
lxc file pull ${CONTAINER}/tmp/work/build/build_ubuntu_1404_x86_lua5.2.tar.gz build/
lxc file pull ${CONTAINER}/tmp/work/build/build_ubuntu_1404_x86_lua5.3.tar.gz build/
