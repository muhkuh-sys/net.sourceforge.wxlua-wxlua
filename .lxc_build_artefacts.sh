...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/net.sourceforge.wxlua-lua*-wxlua/targets/jonchki/repository/net/sourceforge/wxlua/wxlua/*" -type f'`
echo ${FILELIST}
