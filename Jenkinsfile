...
node {
    def ARTIFACTS_PATH = 'build/*/lua5.*/wxlua/targets/jonchki/repository/net/sourceforge/wxlua/wxlua/*'
        ...
        stage(atEntry[0]){
            docker.image("${atEntry[2]}").inside('-u root') {
                ...
                checkout([$class: 'GitSCM',
                    ...
                    submoduleCfg: [],
                    userRemoteConfigs: [[url: 'https://github.com/muhkuh-sys/net.sourceforge.wxlua-wxlua.git']]
                ])
